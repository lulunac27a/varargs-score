...
object NumberLoop {
    ...
    fun main(args: Array<String>) {
        ...
        println("Press 1 for original, 2 for a multiplier, 3 for a multiplier with exponential growth")
        ...
        while (!exit) {
            ...
            if (mode == 2) { //score multiplier mode - enter 1 to 9
                ...
                if ("0" == numberStr) {
                    ...
                    val value = Character.getNumericValue(numberStr.get(0)) //get the numeric value between 1 and 9
